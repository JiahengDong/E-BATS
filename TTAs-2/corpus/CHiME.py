...
class CHiMEDataset(Dataset):
    def __init__(self, split, bucket_size, path="/home/daniel094144/data/CHiME3", enhance=False, ascending=False):
        # Add checkpoints
        print("=== CHIMEDataset Data Loading Checkpoints ===")
        print(f"Path: {path}")
        print(f"Split: {split}")
        ...
        #'et05_bus_simu', 'et05_bus_real', 'et05_caf_real', 'et05_caf_simu','et05_ped_real', 'et05_ped_simu', 'et05_str_real', 'et05_str_simu'
        #'et05_bus_real', 'et05_caf_real','et05_ped_real', 'et05_str_real'
        ...
        for s in split:
            ...
            print(f"Number of files in {s}: {len(split_list)}")
