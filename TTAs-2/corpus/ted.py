...
class TedDataset(Dataset):
    def __init__(self, split, bucket_size, path="/home/daniel094144/data/TEDLIUM_release2/test", enhance=False, ascending=False):
        # Setup
        self.path = path
        ...
        print("first utterance: ", self.file_list[0])
